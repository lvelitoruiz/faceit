										...
										<div className='row'>
											<div className='col-md-12'>
												<p className='mb-2 fs-5'>
													Select the courses or certificates you'd like to
													add to this path
												</p>
											</div>
											<div className='col-md-12'>
									...
									<CardBody>
										<div className='row align-items-center justify-content-center'>
											<div className='col-md-10 text-center pt-5 pb-5'>
												...
												<p className='mb-1'>
													You can now access, edit, and manage your
													Learning Path from the main menu.
												</p>
												...
												<div className='d-lg-flex items-center justify-content-center mt-5 gap-4'>
													<button className='btn btn-outline-dark btn-lg mb-3 mb-lg-0'>
														Return to Learning Path Management
													</button>
													<button className='btn btn-outline-dark btn-lg mb-3 mb-lg-0'>
														Create Another Path
													</button>
