							...
							<div className='py-3'>
								<div className='d-flex align-items-center justify-content-between'>
									<div className='d-flex align-items-center'>
										<div className={`cursor-pointer bg-dark p-1 me-3 d-flex align-items-center justify-content-center rounded-circle ${edit ? '' : 'bg-opacity-10'}`} style={{ width: '30px', height: '30px' }} onClick={ () => handleChange('edit')}>
											<span className='text-white fw-bold'>1</span>
										</div>
										<p className='m-0 d-none d-md-block'>General Details</p>
									</div>
									<div className='d-flex align-items-center'>
										<div className={`cursor-pointer bg-dark p-1 me-3 d-flex align-items-center justify-content-center rounded-circle ${categories ? '' : 'bg-opacity-10'}`} style={{ width: '30px', height: '30px' }} onClick={ () => handleChange('categories')}>
											<span className='text-white fw-bold'>2</span>
										</div>
										<p className='m-0 d-none d-md-block'>Categories and Skills</p>
									</div>
									<div className='d-flex align-items-center'>
										<div className={`cursor-pointer bg-dark p-1 me-3 d-flex align-items-center justify-content-center rounded-circle ${images ? '' : 'bg-opacity-10'}`} style={{ width: '30px', height: '30px' }} onClick={ () => handleChange('images')}>
